...
var media = function media() {
  ...
  var sum = args.reduce(function (accum, num) {
    return accum + num;
  }, 0);
...
var mediaPonderada = function mediaPonderada() {
  ...
  var sum = args.reduce(function (accum, _ref) {
    var number = _ref.number,
      weight = _ref.weight;
    return accum + number * (weight !== null && weight !== void 0 ? weight : 1);
  }, 0);
  var weightSum = args.reduce(function (accum, arg) {
    var _arg$weight;
    return accum + ((_arg$weight = arg.weight) !== null && _arg$weight !== void 0 ? _arg$weight : 1);
  }, 0);
